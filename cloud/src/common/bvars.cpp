...
BvarLatencyRecorderWithTag g_bvar_ms_import_table_meta("ms", "import_table_meta");
...
mBvarInt64Adder g_bvar_rpc_kv_import_table_meta_get_counter("rpc_kv_import_table_meta_get_counter",{"instance_id"});
mBvarInt64Adder g_bvar_rpc_kv_import_table_meta_put_counter("rpc_kv_import_table_meta_put_counter",{"instance_id"});
...
mBvarInt64Adder g_bvar_rpc_kv_import_table_meta_get_bytes("rpc_kv_import_table_meta_get_bytes",{"instance_id"});
mBvarInt64Adder g_bvar_rpc_kv_import_table_meta_put_bytes("rpc_kv_import_table_meta_put_bytes",{"instance_id"});
