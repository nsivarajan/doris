...
class OssObjClient final : public ObjStorageClient {
public:
    OssObjClient(std::shared_ptr<AlibabaCloud::OSS::OssClient> client, std::string endpoint)
            : oss_client_(std::move(client)), endpoint_(std::move(endpoint)) {}
    ~OssObjClient() override;
