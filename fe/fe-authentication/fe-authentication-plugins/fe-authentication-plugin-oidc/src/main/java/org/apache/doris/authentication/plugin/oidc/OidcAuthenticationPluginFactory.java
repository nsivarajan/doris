...
/**
 * Factory for {@link OidcAuthenticationPlugin}.
 *
 ...
 */
public class OidcAuthenticationPluginFactory implements AuthenticationPluginFactory {
    ...
    public AuthenticationPlugin create() {
        return new OidcAuthenticationPlugin();
    }
}
