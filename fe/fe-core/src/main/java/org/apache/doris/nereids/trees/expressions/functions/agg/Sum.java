...
public class Sum extends NullableAggregateFunction
    ...
    /**
     * Create a new Sum with a fixed narrowed DECIMAL return type.
     ...
     * The narrowed signature is injected via an anonymous NullableAggregateFunctionParams
     * subclass that overrides getOriginSignature() to bypass ComputePrecisionForSum,
     * which would otherwise expand back to DECIMAL128.
     */
