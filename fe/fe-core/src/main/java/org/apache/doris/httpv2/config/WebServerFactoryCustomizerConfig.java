                            ...
                            public void lifeCycleStarting(LifeCycle event) {
                                for (org.eclipse.jetty.server.Connector connector : server.getConnectors()) {
                                    if (connector instanceof org.eclipse.jetty.server.ServerConnector) {
                                        ...
                                        org.eclipse.jetty.server.ServerConnector sc = (org.eclipse.jetty.server.ServerConnector) connector;
                                        for (org.eclipse.jetty.server.ConnectionFactory cf : sc.getConnectionFactories()) {
                                            if (cf instanceof org.eclipse.jetty.server.SslConnectionFactory) {
                                                SslContextFactory.Server sslContextFactory = (SslContextFactory.Server) ((org.eclipse.jetty.server.SslConnectionFactory) cf).getSslContextFactory();
