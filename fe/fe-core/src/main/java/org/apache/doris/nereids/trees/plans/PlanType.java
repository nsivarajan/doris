...
public enum PlanType {
    ...
    SHOW_REPLICATION_GROUP_STATUS_COMMAND,
    SHOW_REPLICATION_GROUP_LAG_COMMAND,
    ...
    ALTER_SYSTEM_REPLICATION_FAILOVER,
    ALTER_SYSTEM_REPLICATION_FAILBACK,
    ALTER_SYSTEM_REPLICATION_CREATE_GROUP,
    ALTER_SYSTEM_REPLICATION_PAUSE_EXPORT,
    ALTER_SYSTEM_REPLICATION_PROMOTE_MASTER,
    ALTER_SYSTEM_REPLICATION_ENTER_DR_MODE,
    ALTER_SYSTEM_REPLICATION_ENTER_DRILL_MODE,
    ALTER_SYSTEM_REPLICATION_EXIT_DRILL_MODE,
    ALTER_SYSTEM_REPLICATION_ADD_VAULT_MAPPING,
